  ...
  getDefaultServices(): ServiceConfig[] {
    return [
      ...
      },
      {
        ...
        emoji: '👥',
        color: '#6264A7',
        description: 'Post notifications to Microsoft Teams',
        capabilities: ['Teams Messages', 'Adaptive Cards', 'Channel Notifications'],
        category: 'notifications',
        configVariables: [
          {
            key: 'webhook_url',
            ...
            type: 'password',
            description: 'Incoming webhook URL for Teams',
            required: true,
          ...
          },
          {
            ...
            type: 'boolean',
            description: 'Send rich adaptive card notifications',
            required: false,
            defaultValue: 'true',
          },
        ],
      ...
      },
      {
        ...
        type: 'discord-notifier',
        emoji: '🎮',
        color: '#5865F2',
        description: 'Send notifications to Discord servers',
        capabilities: ['Discord Messages', 'Embeds', 'Webhooks'],
        category: 'notifications',
        configVariables: [
          {
            key: 'webhook_url',
            ...
            type: 'password',
            description: 'Incoming webhook URL for Discord',
            required: true,
          ...
          },
          {
            ...
            label: 'Use Embeds',
            type: 'boolean',
            description: 'Send rich embed notifications',
            required: false,
            defaultValue: 'true',
          },
        ],
      ...
      },
      {
        ...
        capabilities: ['SMS Delivery', 'Urgent Alerts', 'Multiple Providers'],
        category: 'notifications',
        configVariables: [
          {
            key: 'provider',
          ...
          },
          {
            ...
            type: 'text',
            description: 'Comma-separated phone numbers (E.164 format)',
            required: true,
